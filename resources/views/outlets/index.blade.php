...
<div class="container">
    <div class="card mt-5">
        <h3 class="card-header p-3"><i class="fa-solid fa-user"></i> Tugas Darren Rahadian</h3>
        <div class="card-body">
...
<footer>
    ...
    style="text-align:center; background-color:azure">
        Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }}) by Darren Rahadian Web Programming 11
    </div>
</footer>
</html>
